...
As of 2.0.4.1, this mod no longer includes the [Compatibility Framework](https://github.com/BG3-Community-Library-Team/BG3-Compatibility-Framework), which has been separated out into it's own project. Compatibility Framework does rely on functions defined within the Community Library.
